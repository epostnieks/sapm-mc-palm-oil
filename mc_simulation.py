#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Palm Oil / Substitution Impossibility
=====================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Palm Oil (Substitution Impossibility).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "palm_oil",
    "domain_name": "Palm Oil",
    "theorem": "Substitution Impossibility",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 68.0,
    "channels": {
        "C1_carbon_climate": {
            "dist": "lognormal",
            "low": 81.2,
            ...
            "high": 243.5,
            "weight": 0.3,
            "description": "Peatland drainage CO\u2082, land-use change. Indonesia/Malaysia fires. Sources: Carlson et al., WRI."
        },
        "C2_biodiversity_habitat": {
            "dist": "lognormal",
            "low": 58.0,
            "mid": 105.4,
            "high": 173.9,
            "weight": 0.25,
            "description": "Orangutan/tiger/elephant habitat destruction. Sources: IUCN, WWF, Gaveau et al."
        },
        "C3_health_haze": {
            "dist": "lognormal",
            "low": 46.4,
            ...
            "high": 139.1,
            "weight": 0.2,
            "description": "Transboundary haze, 100K+ deaths in 2015. Sources: Koplitz et al. 2016, ASEAN."
        },
        "C4_labor_exploitation": {
            "dist": "normal",
            "low": 50.6,
            "mid": 63.2,
            "high": 75.8,
            "weight": 0.15,
            "description": "Forced/child labor on plantations. Sources: Amnesty International, DOL."
        },
        "C5_governance_certification_failure": {
            "dist": "normal",
            "low": 16.9,
            "mid": 21.1,
            "high": 25.3,
            "weight": 0.1,
            "description": "RSPO inadequacy, greenwashing. Sources: EIA, Greenpeace."
        }
    },
    "impossibility_floor": 3.4
}
